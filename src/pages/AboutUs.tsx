        ...
        <div>
            <Container fluid className='container-desktop' id='container-about-us'>
                ...
                <Container style={{ padding: '0' }}>
                    <h1 id='h1-about-us-our-mission' className='neonText' style={{ background: '#171618', color: 'white', position: 'relative', marginTop: '30px', marginBottom: '30px', textAlign: 'center', zIndex: '1' }}  >
                        OUR MISSION
                    </h1>
