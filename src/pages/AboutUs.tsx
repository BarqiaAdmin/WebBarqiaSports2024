    ...
    return(
        <div>
            <Container fluid className='container-desktop' id='container-about-us' style={{ overflow: 'hidden' }}>
                ...
                <Container style={{ padding: '0' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        <img id='panel_3_i' src='/img/panel_4_i.png' style={{marginTop: '-650px', maxWidth: '25%', position: 'absolute', right: '0', rotate: '360deg', zIndex: '0' }} />
                    </div>
            ...
            <Container className='container-mobile' id='home-container-mobile' style={{ overflow: 'hidden' }}>
                ...
                <h1 id='h1-about-us-our-mission' className='neonText' style={{ background: '#171618', color: 'white', marginTop: '-7px', marginBottom: '0', position: 'relative', textAlign: 'center', zIndex: 1 }}  >
                    OUR MISSION
                </h1>
