...
const Home = () => (
    <Container id='home-container'>
        ...
        <Container style={{ position: 'relative' }}>
            ...
            <div id='the-immersive-platform' style={{ textAlign: 'center', position: 'relative', zIndex: '1' }}>
                <img src='/img/barqia-symbol-gif.gif' style={{ marginTop: '-100px' }} />
            </div>
            <p id='feel-the-passion' style={{ marginTop: '-100px', position: 'relative', zIndex: '1' }}>
