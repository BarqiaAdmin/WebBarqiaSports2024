            ...
            <Container id='home-body'>
                <Row>
                    ...
                    <Col className='col-lg-8'>
                        <img src='/img/home-2.PNG' style={{ marginTop: '-202%', marginLeft: '-12px', width: '1200px' }} />
                    </Col>
                </Row>
            </Container>
                        ...
                        >
                            ...
                            <Offcanvas.Body>
                                <Nav className="justify-content-end flex-grow-1 pe-3" style={{textAlign: 'center'}}>
                                    <Nav.Link className='nav-bar-selected-link' href="/">HOME</Nav.Link>
                                    <Nav.Link style={{
